...
config.General.requestName = 'HydjetDrum5F_V0_MVAeff_MCFull_v7'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = False
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qw_HydjetDrum5F_V0_eff_MVA_v1.py'
#config.JobType.maxJobRuntimeMin = 2500
config.JobType.inputFiles = ['MC_Full_BDT250_D3.LM.weights.xml', 'MC_Full_BDT250_D3.KS.weights.xml']
